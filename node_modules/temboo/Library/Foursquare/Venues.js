...
var ExploreResultSet = function(resultStream) {
    ...
    */
    ...
    this.getRecommendations = function()  {
    	return new  FoursquareRecommendations(JSON.parse(this.getResult('Response'))["response"]);
    }
}
...
var HereNowResultSet = function(resultStream) {
    ...
    */
    this.getHereNowList = function()  {
    	return new  FoursquareHereNowList(getSubArrayByKey(JSON.parse(this.getResult('Response')), "response")["hereNow"]);
    }
}
...
var SearchVenuesResultSet = function(resultStream) {
    ...
    */
    this.getVenues = function()  {
    	var listEntries = getSubArrayByKey(JSON.parse(this.getResult('Response')), "response")["venues"];
    	var resultArray = new Array();
    	if(listEntries != null) {
    		for(var i=0; i < listEntries.length; i++) {
    			resultArray[i] = new  FoursquareVenue(listEntries[i]);
    		}
    	}
    	return resultArray;
    }
...
var SimilarResultSet = function(resultStream) {
    ...
    */
    this.getVenues = function()  {
    	var listEntries = getSubArrayByKey(getSubArrayByKey(JSON.parse(this.getResult('Response')), "response"), "similarVenues")["items"];
    	var resultArray = new Array();
    	if(listEntries != null) {
    		for(var i=0; i < listEntries.length; i++) {
    			resultArray[i] = new  FoursquareVenue(listEntries[i]);
...
var TipsFromVenueResultSet = function(resultStream) {
    ...
    */
    this.getTips = function()  {
    	var listEntries = getSubArrayByKey(getSubArrayByKey(JSON.parse(this.getResult('Response')), "response"), "tips")["items"];
    	var resultArray = new Array();
    	if(listEntries != null) {
    		for(var i=0; i < listEntries.length; i++) {
...
var VenueDetailResultSet = function(resultStream) {
    ...
    */
    this.getVenue = function()  {
    	return new  FoursquareVenue(getSubArrayByKey(JSON.parse(this.getResult('Response')), "response")["venue"]);
    }
}
...
var VenueEventsResultSet = function(resultStream) {
    ...
    */
    this.getEvents = function()  {
    	var listEntries = getSubArrayByKey(getSubArrayByKey(JSON.parse(this.getResult('Response')), "response"), "events")["items"];
    	var resultArray = new Array();
    	if(listEntries != null) {
    		for(var i=0; i < listEntries.length; i++) {
    			resultArray[i] = new  FoursquareEvent(listEntries[i]);
    		}
    	}
    	return resultArray;
    }
...
/*
 Contains pieces needed to construct badge image at various sizes. Combine prefix with one of the sizes and a name to construct the url for a badge image
...
var FoursquareBadgeImage = function(base) {
	...
	*/
	...
	/*
	The prefix portion of the badge url
	*/
	...
	/*
	Contains the available sizes of badge images
	*/
...
var FoursquareLeaderboardScores = function(base) {
	...
	/*
	The count of checkins for the user
	*/
