d3.json("/data/stream_reformatted.json", function (tweets) {
	...
	d3.json("data/us-states.json", function (statesJson) {
		...
		d3.json("data/states_hash.json", function (states_hash) {
			...
			// var statesCountMax = statesGroup.order(function(p) {return p.value.count;}).top(2)[1].value.count;
			// var statesCountMin = d3.min(statesGroup.order().top(Infinity), function(d) {return d.value.count;});
			// var friends_count_max = d3.max(statesGroup.top(Infinity).filter(function(e) {if(typeof e.value.friends_count_avg != 'undefined') return e}), function(d) {return d.value.friends_count_avg});
			// var friends_count_min = d3.min(statesGroup.top(Infinity).filter(function(e) {if(typeof e.value.friends_count_avg != 'undefined') return e}), function(d) {return d.value.friends_count_avg});
			// var followers_count_max = d3.max(statesGroup.top(Infinity).filter(function(e) {if(typeof e.value.followers_count_avg != 'undefined') return e}), function(d) {return d.value.followers_count_avg});
			// var followers_count_min = d3.min(statesGroup.top(Infinity).filter(function(e) {if(typeof e.value.followers_count_avg != 'undefined') return e}), function(d) {return d.value.followers_count_avg});
			// var statuses_count_max = d3.max(statesGroup.top(Infinity).filter(function(e) {if(typeof e.value.statuses_count_avg != 'undefined') return e}), function(d) {return d.value.statuses_count_avg});
			// var statuses_count_min = d3.min(statesGroup.top(Infinity).filter(function(e) {if(typeof e.value.statuses_count_avg != 'undefined') return e}), function(d) {return d.value.statuses_count_avg});
			...
			bubbleChart.width(600)
					   ...
					   .elasticRadius(true)
					   .yAxisPadding(7)
					   .label(function(p) {return p.value.tweet_length_avg.toFixed(0);})
					   .renderLabel(true);
